...
<section>
    ...
    <h1>Privacy policy outlining the use of personal data</h1>
        <p>This website is owned and run by HappyTravelDotCom Travel and Tourism LLC (Happy Travel). The term “our online services” refers to happytravel.com, our pages on third party social media platforms such as Instagram, Facebook, Twitter, and any other websites or apps we run. The term “our services” refers to our online services and any of our other products and services. If you use any of our services, we will refer to you using the terms “user”, “visitor”, “you”, “your”, “yours” in this policy.</p>
    ...
    <h2>Registration</h2>
        ...
        <p>The account password you provide should be unique and kept secure, and you must notify Happy Travel immediately of any breach of security or unauthorized use of your account.</p>
        <p>What kind of personal information does Happy Travel collect?</p>
        <p>When you make a reservation, you will be asked for your name, address, telephone number, email address, payment details, number of passengers and confirmation number for payment sent from Happy Travel team.</p>
        ...
        <p>Happy Travel receives an information when you use social media services.</p>
        <h2>Does Happy Travel share your information with third-party?</h2>
