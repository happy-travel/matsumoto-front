let settings = {
    ...
    edo_url               : process.env.EDO_URL || "https://edo-api.dev.happytravel.com/",
    edo_v1                : "/api/1.0",

    identity_url          : process.env.IDENTITY_URL || "https://identity.dev.happytravel.com/",
    ...
    sentryDSN             : process.env.SENTRY_DSN || "https://21e4194b435946e0b2e20444d6948d25@sentry.dev.happytravel.com/4"
};
