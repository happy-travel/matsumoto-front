...
translations: {
    ...
    "Create a new one": "إنشاء حساب",
    "Log In Information": "معلومات تسجيل الدخول",
    "User Information": "معلومات المستخدم",
    "Company Information": "معلومات الشركة",
    "Get started with a new account": "ابدأ بإنشاء حساباً مجانياً",
    "Create a HappyTravel.com account and start booking.": "انشئ حساباً مجانياً في موقعنا HappyTravel واحجز عطلتك اليوم",
    ...
    "One number": "رقم واحد",
    "10 characters minimum": "الحد الأدنى هو 10 حروف",
    ...
    "Search accommodation": "البحث عن فندق",
    ...
    "All": "الجميع",
    "Available Accommodations": "الفنادق المتاحة",
    "Radius (Km)": "نطاق (كم)",
    ...
    "Accommodation Details": "تفاصيل الفندق",
